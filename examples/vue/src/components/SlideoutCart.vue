...
<template>
  <div class="slideout-cart-wrapper" :class="{ open: cartStore.open }">
...
.slideout-cart-wrapper {
  ...
  @apply absolute top-0 bottom-0 right-0 max-w-full w-96 bg-white text-black flex flex-col justify-start items-center pt-16;
}

.slideout-cart-wrapper.open {

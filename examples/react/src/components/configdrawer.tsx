      ...
      >
        ...
        <Box p={1} textAlign="center" role="configurations">
          <Grid container spacing={2}>
            ...
            <Grid item xs={8}>
              <Typography variant="h6" component="div">Configurations</Typography>
            </Grid>
            <Grid item xs={3}>
        ...
        <Box sx={{ overflow: 'auto' }}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Typography variant="body1" component="div">General</Typography>
            </Grid>
            <Grid item xs={12} sm={4} >
              <Typography variant="body2" component="div">Search url</Typography>
            </Grid>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Typography variant="body1" component="div">Recommandations</Typography>
            </Grid>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Typography variant="body1" component="div">Category</Typography>
            </Grid>
            <Grid item xs={12}>
              <Box>
                <List>
                  <ListItem>
                    <Grid container spacing={2}>
                      <Grid item xs={5}>
                        <Typography variant="body2" component="div">Key</Typography>
                      </Grid>
                      <Grid item xs={5}>
                        <Typography variant="body2" component="div">Label</Typography>
                      </Grid>
                      <Grid item xs={2}>
                        <Typography variant="body2" component="div">Emoji</Typography>
                      </Grid>
                    </Grid>
                  </ListItem>

...
export const KlevuProduct = /*@__PURE__*/createReactComponent<JSX.KlevuProduct, HTMLKlevuProductElement>('klevu-product');
export const KlevuProductGrid = /*@__PURE__*/createReactComponent<JSX.KlevuProductGrid, HTMLKlevuProductGridElement>('klevu-product-grid');
export const KlevuProductQuery = /*@__PURE__*/createReactComponent<JSX.KlevuProductQuery, HTMLKlevuProductQueryElement>('klevu-product-query');
export const KlevuProductQueryButton = /*@__PURE__*/createReactComponent<JSX.KlevuProductQueryButton, HTMLKlevuProductQueryButtonElement>('klevu-product-query-button');

...
[models/KlevuApiRawResponse.ts:55](https://github.com/klevultd/frontend-sdk/blob/f14d7e9/packages/klevu-core/src/models/KlevuApiRawResponse.ts#L55)

`](modules.md#klevufilterresultslider))[] | Currently available filters |

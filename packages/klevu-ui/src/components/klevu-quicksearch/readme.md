...
| `lastClickedProductsCaption` | `last-clicked-products-caption` | Recently clicked tab caption Supports showing the count in place of %s in the value eg: `Recently Searched (%s)` with count of 2 will lead to `Recently Searched (2)`. | `string \| undefined`                                                                                                                                                             | `undefined`                                        |
| `placeholder`                | `placeholder`                   | Placeholder for input text                                                                                                                                             | `string \| undefined`                                                                                                                                                             | `undefined`                                        |
| `popularProductsTitle`       | `popular-products-title`        | Popular products section heading                                                                                                                                       | `string \| undefined`                                                                                                                                                             | `undefined`                                        |
...
| `showPopularKeywords`        | `show-popular-keywords`         | Show popular keywords                                                                                                                                                  | `boolean \| undefined`                                                                                                                                                            | `undefined`                                        |
...
| `trendingCaption`            | `trending-caption`              | Trending tab caption Supports showing the count in place of %s in the value eg: `Trending (%s)` with count of 2 will lead to `Trending (2)`.                           | `string \| undefined`                                                                                                                                                             | `undefined`                                        |

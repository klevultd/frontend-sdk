...
| `tLastClickedProductsCaption` | `t-last-clicked-products-caption` | Recently clicked tab caption                           | `string`                                                                                                                                                                          | `""`                                               |
...
| `tTrendingCaption`            | `t-trending-caption`              | Trending tab caption                                   | `string`                                                                                                                                                                          | `""`                                               |

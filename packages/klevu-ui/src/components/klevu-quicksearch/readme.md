...
| ----------------------------- | --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| `customUrlRedirects`          | --                                | Pass your own redirect urls for a keyword                                                                                                                              | `KlevuKeywordUrlMap[] \| undefined`                                                                                                                                               | `undefined`                                        |
...
| `popularProductsCount`        | `popular-products-count`          | How many products to show in Popular products section                                                                                                                  | `number`                                                                                                                                                                          | `10`                                               |

...
| `tPlaceholder`      | `t-placeholder`      | The placeholder text to display in the search field. | `string`                                                                                                                                                                                                                                                                                                                                                | `"Search for products"` |
| `tSearchText`       | `t-search-text`      | Button text                                          | `string`                                                                                                                                                                                                                                                                                                                                                | `"Search"`              |

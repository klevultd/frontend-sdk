...
| `showPriceAsSlider`          | `show-price-as-slider`          | Show price as options                                           | `boolean \| undefined`                                                                                                                                                                                                                                                                                                                                  | `undefined`                                        |
...
| `useKlaviyo`                 | `use-klaviyo`                   | Enable Klaviyo integration                                      | `boolean \| undefined`                                                                                                                                                                                                                                                                                                                                  | `undefined`                                        |

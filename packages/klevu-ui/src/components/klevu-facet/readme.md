...
| `colorSwatchOverrides` | --                     | Specific overrides for individual color swatch. The overrides can be colors (hex or valid css colors) or a valid url to load. ImageUrl takes precedence over color when both are specified. | `undefined \| { [key: string]: { color?: string \| undefined; imageUrl?: string \| undefined; }; }`                                                                            | `{}`                            |
...
| `tMore`                | `t-more`               |                                                                                                                                                                                             | `any`                                                                                                                                                                          | `getTranslation("facet.tMore")` |
| `useColorSwatch`       | `use-color-swatch`     | Converts the color filters to swatches                                                                                                                                                      | `boolean \| undefined`                                                                                                                                                         | `false`                         |
...
- [klevu-color-swatch](../klevu-color-swatch)

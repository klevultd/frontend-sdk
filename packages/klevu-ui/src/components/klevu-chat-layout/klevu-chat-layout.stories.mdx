  ...
  <Story name="Chat">
    {(args) => html`
      <klevu-chat-layout>
        ...
        <klevu-slides>
          <klevu-product variant="small" .product=${productItem}></klevu-product>
          <klevu-product variant="small" .product=${productItem}></klevu-product>
          <klevu-product variant="small" .product=${productItem}></klevu-product>
          <klevu-product variant="small" .product=${productItem}></klevu-product>
          <klevu-product variant="small" .product=${productItem}></klevu-product>
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 8px; padding: 8px 8px 16px;">
          <klevu-button is-secondary>Option 1</klevu-button>
          <klevu-button is-secondary>Option 2</klevu-button>
          <klevu-button is-secondary>Option 3</klevu-button>
          <klevu-button is-secondary>Option 4</klevu-button>
        </div>

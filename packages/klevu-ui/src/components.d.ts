...
import {
  KlevuColorSwatchOverride as KlevuColorSwatchOverride1,
  KlevuFiltersAppliedEventDetail,
} from "./components/klevu-facet-list/klevu-facet-list"
...
} from "./components/klevu-quicksearch/klevu-quicksearch"
import {
  SearchFieldVariant as SearchFieldVariant1,
  SearchResultsEventData,
  SuggestionsEventData,
} from "./components/klevu-search-field/klevu-search-field"
...
declare namespace LocalJSX {
  ...
  interface KlevuChatMessages {
     ...
     */
    onKlevuSelectFilter?: (
      event: KlevuChatMessagesCustomEvent<{
        message: MoiResponseFilter
        filter: MoiResponseFilter["filter"]["options"][0]
      }>
    ) => void
    /**
     * When product option is clicked
     */
    onKlevuSelectProductOption?: (
      event: KlevuChatMessagesCustomEvent<{ product: MoiProduct; option: MoiProduct["options"][0] }>
    ) => void
    /**
     * What message should we
     */
  ...
  interface KlevuMerchandising {
    ...
    limit?: number
    onData?: (
      event: KlevuMerchandisingCustomEvent<{
  ...
  interface KlevuSearchLandingPage {
    ...
    limit?: number
    onData?: (
      event: KlevuSearchLandingPageCustomEvent<{
        resultObject: KlevuResponseQueryObject
        records: KlevuRecord[]
        manager: FilterManager
      }>
  ...
  interface KlevuUtilDomEvents {
    onClickEventSent?: (
      event: KlevuUtilDomEventsCustomEvent<{
        productId: string
        product?: Partial<KlevuRecord>
      }>
    ) => void
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
       ...
       * @cssprop --klevu-loading-indicator-color --klevu-color-primary Color of the loading indicator
       */
      "klevu-loading-indicator": LocalJSX.KlevuLoadingIndicator &
        JSXBase.HTMLAttributes<HTMLKlevuLoadingIndicatorElement>
      /**
       * Full merchandising app to power up your product grid pages
       */
       ...
       * @csspart popup-content - Popup content element
       */
      "klevu-product-query-popup": LocalJSX.KlevuProductQueryPopup &
        JSXBase.HTMLAttributes<HTMLKlevuProductQueryPopupElement>
      /**
       * __klevu-query__ component is a special kind of component that makes queries to Klevu defined by the
       * __type__ parameter. It also listens to clicks to __klevu-product__ -component and sends analytical data to Klevu
       * based on that. This components gives you ability to create any kind of UI with Klevu components or by using your own
       ...
       * Full app component for search landing page
       */
      "klevu-search-landing-page": LocalJSX.KlevuSearchLandingPage &
        JSXBase.HTMLAttributes<HTMLKlevuSearchLandingPageElement>
      /**
       * Horizontal slider component. By default used for price range in this package. But can
       * be used for other purposes as well.
       */
       ...
       * Component that triggers event when intercepted on scroll of page.
       */
      "klevu-util-infinite-scroll": LocalJSX.KlevuUtilInfiniteScroll &
        JSXBase.HTMLAttributes<HTMLKlevuUtilInfiniteScrollElement>
      /**
       * Portal component to move content to end of body instead of normal DOM position. Typically used for popups
       * to prevent problems with CSS stylings.
       * Does not move styles, so create a child component that has styles defined in shadow DOM.

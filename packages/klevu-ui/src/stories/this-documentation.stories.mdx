...
<Meta title="Start/This documentation" />
...
Here is a example how to create `klevu-init` component in HTML. And then getting reference to to said element and setting
some properites on it.

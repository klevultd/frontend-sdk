...
# Welcome to Klevu Web Components (Alpha!)
...
KlevuInit is an essential component that can be used to set backend configuration for any Klevu Components within the DOM tree.
Through a single instance of KlevuInit, global configurations for various components
are defined - as demonstrated by its usage in VanillaJS. Currently only one KlevuInit is allowed in the document.

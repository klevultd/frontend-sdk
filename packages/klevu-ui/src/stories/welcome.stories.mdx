...
KlevuInit is an essential component that can be used to set up any components within the DOM tree, ensuring all data
from Klevu's backend is accessed. Through a single instance of KlevuInit, global configurations for various components

...
Please download the zip or tar.gz file for the release.

Extract the file into a folder and specify the paths to the files as mentioned in the example below.
...
<html>
  <head>
    ...
    <meta charset="UTF-8" />
    <script type="module" src="{PATH TO klevu-ui.esm.js}"></script>
    <link href="{PATH TO klevu-ui.css}" rel="stylesheet" />
  </head>

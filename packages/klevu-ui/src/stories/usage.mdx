...
```html
<klevu-init
  assets-path="https://resources-webcomponents.klevu.com/latest/klevu-ui" /* optional */
...
myComponent.settings = {
  onItemClick: function onProductClick(product, event) {
...
We provide a ready made library `@klevu/ui-react` for React that changes Klevu Components to React Components.
...
const App = () => {
  return (
    <KlevuInit
      ...
      assetsPath="https://resources-webcomponents.klevu.com/latest/klevu-ui" //optional
    />
  )
}
```

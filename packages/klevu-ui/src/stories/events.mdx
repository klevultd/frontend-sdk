...
# Listening to Klevu Web Component Events

Klevu Web components offer a rich set of events that you can listen to in order to respond to user interactions and
customize the behavior of your e-commerce website. This documentation page provides an overview of the standard way to
listen to events emitted by Klevu Web components. Below is a listing of events from various components along with the
typings of the `CustomEvent` detail property.

## Event Listening

To listen to events emitted by Klevu Web components, you can use the standard event listening approach in JavaScript.
Here's how you can do it:

```javascript
// Select the element that contains the Klevu Web component
...
If you are using React to build your e-commerce website and want to listen to events emitted by Klevu Web components, you can achieve this by using React component properties directly.
...
Here's an example of how to listen to a Klevu Web component event in a React component:
